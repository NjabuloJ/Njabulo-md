...
module.exports = {
  ...
  run: async (context) => {
    ...
    const menuText = `____________________________________\n *ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ғᴀᴍɪʟʏ ᴏɴʟɪɴᴇ!🍥* \n\n` +
      `🍟 *Bσƚ*: ${botname} (bow down)\n` +
      `🌮 *Pɾҽϝιx*: ${effectivePrefix} (learn it, dumbass)\n` +
      `🍥 *Mσԃҽ*: ${mode} (deal with it)\n` +
      `\n____________________________________\n\n` +
      `*sᴇʟᴇᴄᴛ ᴀɴᴅ ᴏᴘᴛɪᴏɴ sᴇᴇ ᴄᴍᴅ🍥*`;
            ...
            buttons: [
              {
                ...
                buttonParamsJson: JSON.stringify({
                  display_text: 'Family bot',
                  url: 'https://whatsapp.com/channel/0029VbAckOZ7tkj92um4KN3u',
                  merchant_url: 'https://whatsapp.com/channel/0029VbAckOZ7tkj92um4KN3u',
                }),
              },
              {
                name: 'single_select',
